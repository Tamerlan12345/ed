...
`;
            ...
            finalPrompt = `
                ...
                2.  **СПЕЦИАЛЬНОЕ ПРАВИЛО ДЛЯ ЦИФР (ВАЖНО):**
                    * Если в тексте встречаются **страховые премии, тарифы, проценты выплат или цены**, ты ОБЯЗАН добавить на слайд сноску.
                    * Текст сноски: "*Информация может быть не актуальна. Пожалуйста, проверяйте актуальные данные в программе страхования.*"
                    * Сноску размещай внизу слайда в теге <small>.

                3.  **Структура курса (12 слайдов):**
                    * Слайды 2-11: Основная часть.
                    * Слайд 12: Выводы.

                4.  **Правило переполнения:**
                    * Если текста слишком много, выдели главное, поставь (*) и добавь сноску: \`<small>* - полные условия см. в Договоре.</small>\`

                5.  **Формат HTML:** Заголовки \`<h2>\`, списки \`<ul>\`, выделение \`<strong>\`.
