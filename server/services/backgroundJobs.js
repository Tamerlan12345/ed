...
4.  **Формат слайда (HTML):**
    ...
    * **Важно:** Текст должен быть **понятным, развернутым и объясняющим**, а не просто сухим списком тезисов. Если пункт требует пояснения — напиши его. Избегай чрезмерного сокращения в ущерб смыслу.
