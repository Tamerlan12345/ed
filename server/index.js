...
1.  **Презентация (summary):** Создай содержательную и ОЧЕНЬ информативную HTML-презентацию. Если в задании от пользователя не указано иное, сделай ровно 8 слайдов. Пользователь в своем задании может попросить изменить количество слайдов или объем контента — следуй его указаниям. В каждом слайде давай подробные объяснения, приводи конкретные примеры, и раскрывай тему как можно полнее. Контент должен быть максимально полезным и детальным. Активно используй теги <h2>, <p>, <ul>, <li>, <strong>.
