...
async function generateContent(payload) {
    ...
    if (custom_prompt) {
        ...
        1.  **Учебные слайды:** Сгенерируй подробный учебный материал, разбитый на серию слайдов. Каждый слайд должен представлять собой объект с полями "title" и "html_content". Контент должен быть объемным и полностью охватывать исходный текст.
        2.  **Тестовые вопросы:** Создай ровно 30 тестовых вопросов для проверки знаний по всему материалу. Вопросы должны быть сложными, разнообразными и охватывать все ключевые аспекты учебного курса. Каждый вопрос должен иметь 4 варианта ответа и указание на правильный.
