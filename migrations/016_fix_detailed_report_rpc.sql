...
-- Причина: INNER JOIN падал, если у пользователя не было профиля или других связанных данных.
-- Решение: Заменить JOIN на LEFT JOIN для большей отказоустойчивости.
